...
<body>
    ...
    <script>
        ...
        var createScene = function () {
            ...
            box.material.diffuseTexture = new BABYLON.Texture("textures/shopium.png", scene);
            ...
            box2.material.diffuseTexture = new BABYLON.Texture("textures/shopium.png", scene);
            box2.material.diffuseTexture.hasAlpha = false;
            box2.position = new BABYLON.Vector3(8, -9, -10);
            var box3 = new BABYLON.Mesh.CreateBox("crate", 2, scene);
            box3.material = new BABYLON.StandardMaterial("Mat", scene);
            box3.material.diffuseTexture = new BABYLON.Texture("textures/shopium.png", scene);
            box3.material.diffuseTexture.hasAlpha = false;
            box3.position = new BABYLON.Vector3(8, -7, -10);
